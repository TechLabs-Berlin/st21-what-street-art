...
But we sought to go even beyond the above features. We wanted to offer our users the ability to utilize AI technology to identify an artwork either from using a device’s camera scan, or from a photo upload. 
