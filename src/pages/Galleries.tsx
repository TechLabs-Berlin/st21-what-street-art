...
export const Galleries: React.FC = () => {
  ...
  <IonPage>
    <Header />
      <IonContent>
        <div>
        <Swiper slidesPerView={2} spaceBetween={10} pagination={{"clickable": true}} className="mySwiper1">
        ...
        <div>
        <Swiper slidesPerView={2} spaceBetween={10} pagination={{"clickable": true}} className="mySwiper2">
        ...
        <div>
        <Swiper slidesPerView={2} spaceBetween={10} pagination={{"clickable": true}} className="mySwiper3">
